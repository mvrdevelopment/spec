...
| UseEmitter         | [Enum](#user-content-attrtype-enum )         | Indication whether this attribute typically utilizes [Emitters](#user-content-emitter-collect ). The currently defined values are: "True", "False" |
| UseFilter          | [Enum](#user-content-attrtype-enum )         | Indication whether this attribute typically utilizes [Filters](#user-content-filter-collect ). The currently defined values are: "True", "False" |
| UseWheel           | [Enum](#user-content-attrtype-enum )         | Indication whether this attribute typically utilizes [Wheels](#user-content-wheel-collect ). The currently defined values are: "True", "False" |
